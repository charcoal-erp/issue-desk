 ...
 * irreplaceable structured data (config + all issue/Checkpoint JSON) into a
 * rotating set of restore points under `data/.backups/<timestamp>/`, so an
 * accidental deletion or bad edit is always one restart away from recovery.
 *
