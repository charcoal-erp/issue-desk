import { S as attr, a as ensure_array_like, c as stringify, i as derived, n as attr_style, t as attr_class, w as escape_html } from "../../chunks/server.js";
import { i as STATUS_META, n as PRIORITIES, o as PRIORITY_META, r as STATUSES } from "../../chunks/types.js";
import { t as filterToParams } from "../../chunks/filter.js";
import { t as issueToMarkdown } from "../../chunks/toMarkdown.js";
import { t as goto } from "../../chunks/client.js";
import { t as page } from "../../chunks/state.js";
import { i as Icon, n as toast, t as Avatar } from "../../chunks/Avatar.js";
import { i as fmtWhen, n as fmtDateTime } from "../../chunks/format.js";
import { n as openEditIssue, t as openDrawer } from "../../chunks/ui.svelte.js";
...
//#region src/lib/export/copyIssue.ts
/** Single-issue prompt for the per-row / drawer "Copy for Claude Code". */
function singleIssueMarkdown(issue, users, baseUrl) {
...
function FilterRail($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { applications, counts, filter, onChange } = $$props;
...
function FilterChips($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { filter, applications, onChange, onClearAll } = $$props;
...
function IssueRow($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { issue, users, appColor, onOpen, onEdit, onCopy } = $$props;
...
function IssueTable($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		let { rows, users, applications, filter, onSort, onOpen, onEdit, onCopy } = $$props;
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		function sortBy(key) {
			...
			const newestFirst = (k) => k === "priority" || k === "updated" || k === "created";
			...
			if (current === key) navigate({
				...
				sort: key,
				dir: newestFirst(key) ? "desc" : "asc"
			});
		}
		async function copyIssue(issue) {
			try {
				await navigator.clipboard.writeText(singleIssueMarkdown(issue, data.users, location.origin));
