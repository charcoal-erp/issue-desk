	...
	<div class="dash">
		...
		<div class="dash-grid">
			<div class="panel">
				<div class="panel-hd">
					Recent runs
					<a class="btn btn-ghost btn-sm ph-act" href="/runs">All runs</a>
				</div>
				<div class="panel-bd">
					{#if data.recent.length}
						<div class="spark">
							{#each data.recent as r (r.id)}
								...
								<a class="spark-col" href="/runs/{r.id}" title="{r.id} — {pct(r.passRate)} pass">
			...
			<div class="panel">
				<div class="panel-hd">
					System health
					<a class="btn btn-ghost btn-sm ph-act" href="/runners">Runners</a>
				</div>
			...
			<div class="panel">
				...
				<div class="panel-bd tight">
					{#each data.failing as f (f.id)}
						<a class="fail-row" href="/cases?case={f.id}">
