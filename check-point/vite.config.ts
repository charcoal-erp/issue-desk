...
export default defineConfig({
	...
	server: {
		allowedHosts: ['checkpoint.charqol.com', 'localhost', '127.0.0.1']
	},
	test: {
		include: ['tests/**/*.test.ts'],
		// Every store test file wipes and reseeds the one shared DATA_DIR
		...
		env: {
			...
			DATA_DIR: '/tmp/checkpoint-vitest-data'
		}
	}
});
